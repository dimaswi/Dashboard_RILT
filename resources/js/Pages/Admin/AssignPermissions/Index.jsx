...
export default function Index(props) {
    const { data: assign_permissions, meta } = props.assign_permissions;
    ...
    return (
        <div className="flex flex-col w-full pb-32">
            <div className="flex felx-col items-start justify-between mb-8 lg:flex-row lg:items-center">
                ...
                >
                    <Link
                        href={route('admin.assign-permissions.create')}
                    >
            ...
            <Card>
                ...
                <CardContent className="px-0 py-0 [&-td]:whitespace-nowrap [&_td]:px-6 [&_th]:px-6">
                    <Table className="w-full">
                        ...
                        <TableBody>
                            {assign_permissions.map((role, index) => (
                                                    ...
                                                    <AlertDialogHeader>
                                                        ...
                                                        <AlertDialogFooter>
                                                            ...
                                                            <AlertDialogAction className="bg-red-600" onClick={
                                                                () => {
                                                                    router.delete(
                                                                        route('admin.assign-permissions.destroy', [role]), {
                                                                        preserveScroll: true,
                                                                        preserveState: true,
                                                                        onSuccess: (success) => {
                ...
                <CardFooter className="flex flex-col items-center justify-between w-full py-2 border-t lg:flex-row">
                    <p>
                        Menampilkan <span className="font-medium text-orange-500">{meta.from} - {meta.to}</span> dari {meta.total} Permissions
                    </p>
