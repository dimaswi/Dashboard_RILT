...
import { ArrowUpDown, BookAIcon, Building2Icon, Pencil, PlusCircle, SquareMenuIcon, Trash, User2Icon } from "lucide-react"
                    ...
                    <Table className="w-full">
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead>
                                    <Button variant="ghost" className="grup inline-flex" onClick={() => onSortable('phone')}>
                                        Nomor Telepon
                                        <span className="ml-2 flex-none rounded text-muted-foreground">
                                            <ArrowUpDown className="size-4 text-muted-foreground" />
                                        </span>
                                ...
                                <TableHead>
                                    <Button variant="ghost" className="grup inline-flex" onClick={() => onSortable('address')}>
                                        Alamat
                                        <span className="ml-2 flex-none rounded text-muted-foreground">
                                            <ArrowUpDown className="size-4 text-muted-foreground" />
                                        </span>
                                ...
                                <TableHead>
                                    <Button variant="ghost" className="grup inline-flex" onClick={() => onSortable('date_of_birth')}>
                                        Tanggal Lahir
                                        <span className="ml-2 flex-none rounded text-muted-foreground">
                                            <ArrowUpDown className="size-4 text-muted-foreground" />
                                        </span>
                                ...
                                <TableHead>
                                    <Button variant="ghost" className="grup inline-flex" onClick={() => onSortable('gender')}>
                                        Jenis Kelamin
                                        <span className="ml-2 flex-none rounded text-muted-foreground">
                                            <ArrowUpDown className="size-4 text-muted-foreground" />
                                        </span>
                                                    ...
                                                    <AlertDialogHeader>
                                                        ...
                                                        <AlertDialogFooter>
                                                            ...
                                                            <AlertDialogAction className="bg-red-600" onClick={
                                                                () => {
                                                                    router.delete(
                                                                        route('admin.users.destroy', [book]), {
                                                                        preserveScroll: true,
                                                                        preserveState: true,
                                                                        onSuccess: (success) => {
