...
import { ArrowUpDown, Building2Icon, LockKeyhole, Pencil, PlusCircle, RouteIcon, SquareMenuIcon, Trash, User2Icon } from "lucide-react"
    ...
    return (
        <div className="flex flex-col w-full pb-32">
            <div className="flex felx-col items-start justify-between mb-8 lg:flex-row lg:items-center">
                ...
                >
                    <Link
                        href={route('admin.route-accesses.create')}
                    >
            ...
            <Card>
                    ...
                    <Table className="w-full">
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead>
                                    <Button variant="ghost" className="grup inline-flex" onClick={() => onSortable('route_name')}>
                                        Route
                                        <span className="ml-2 flex-none rounded text-muted-foreground">
                                            <ArrowUpDown className="size-4 text-muted-foreground" />
                                        </span>
                                ...
                                <TableHead>
                                    <Button variant="ghost" className="grup inline-flex" onClick={() => onSortable('role_id')}>
                                        Role
                                        <span className="ml-2 flex-none rounded text-muted-foreground">
                                            <ArrowUpDown className="size-4 text-muted-foreground" />
                                        </span>
                                ...
                                <TableHead>
                                    <Button variant="ghost" className="grup inline-flex" onClick={() => onSortable('permission_id')}>
                                        Permission
                                        <span className="ml-2 flex-none rounded text-muted-foreground">
                                            <ArrowUpDown className="size-4 text-muted-foreground" />
                                        </span>
                ...
                <CardFooter className="flex flex-col items-center justify-between w-full py-2 border-t lg:flex-row">
                    <p>
                        Menampilkan <span className="font-medium text-orange-500">{meta.from} - {meta.to}</span> dari {meta.total} Route Akses
                    </p>
