        ...
        <div className="flex flex-col w-full pb-32">
            ...
            <Card>
                                    ...
                                    <TableCell>
                                        <div className="flex items-center gap-x-1">
                                            <Button variant="orange" size="sm" asChild>
                                                <Link href={route('admin.roles.edit', [book])}>
                                                    ...
                                                    <AlertDialogHeader>
                                                        ...
                                                        <AlertDialogFooter>
                                                            ...
                                                            <AlertDialogAction className="bg-red-600" onClick={
                                                                () => {
                                                                    router.delete(
                                                                        route('admin.roles.destroy', [book]), {
                                                                        preserveScroll: true,
                                                                        preserveState: true,
                                                                        onSuccess: (success) => {
                ...
                <CardFooter className="flex flex-col items-center justify-between w-full py-2 border-t lg:flex-row">
                    <p>
                        Menampilkan <span className="font-medium text-orange-500">{meta.from} - {meta.to}</span> dari {meta.total} Role
                    </p>
